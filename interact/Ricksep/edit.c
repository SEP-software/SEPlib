...
int EditStats (int n,float *dist,int *low,int *median,int *high)
	{
	int i;
...
int EditGrade (Buffer data,Map map1,Map map2,Map map3)
	{
	Buffer bufferp;
	Vec vecp;
