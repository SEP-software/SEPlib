...
Plane PlaneFind (int dir3,int frame3,int dir4,int frame4,int dir5,int frame5,int check_pick)
	{
	Plane plane;
...
/* record a plane */
void PlaneSet (Map hmap,Map vmap,Map zmap,Map map4,Map map5,int h0,int v0,int nh,int nv,Render render,int *margins,RenderAttr attr,int pickable)
	{
	plane->hmap = hmap;
	plane->vmap = vmap;
	plane->zmap = zmap;
