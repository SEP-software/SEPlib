...
extern int gl_tjust_j(char*);
extern int gl_transp( float*, float*,struct datainfo *); 
extern int gl_transp_g( float*, float*,struct datainfo_g *); 
extern int gl_uarea(float*,float*,int,int,int,int,int);
extern int gl_uarea_g(float*,float*,int,int,int,int,int);
...
extern int gl_upmark_g(int,int,int,float *,float *);
