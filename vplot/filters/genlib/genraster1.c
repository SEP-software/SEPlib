...
/*ARGSUSED7*/
void
genraster1 (int count, int out_of, int xpos, int ypos, int length, int orient, unsigned short *raster, int dummy1, int dummy2, int byte2)
#else
genraster1 (count, out_of, xpos, ypos, length, orient, raster, dummy1, dummy2,byte2)
...
/*   if(byte2==1)*/
/*   ERR(FATAL,"Asked for two byte option with generaster1 (unimplemented) \n");*/
 ...
 */
    ...
    {
	array[length * ylength + ii] = (unsigned char) raster[ii];
