...
%changelog
* Mon Jan 22 2001 New version
* Mon Oct 25 1999 New version
- What is the problem
...
%install
make install
cd /usr/local/SEP; gunzip -c /usr/src/redhat/SOURCES/seplib-6.0.tar.gz | tar x;mv /usr/local/SEP/seplib-6.0 /usr/local/SEP/src ; cd /usr/local/SEP/src;./RPM_BUILD_DISTR;gmake untar-parts
